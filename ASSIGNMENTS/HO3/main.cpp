...
struct Node {
  ...
  bool operator>(const Node& obj) {
    ...
    //overloads the < operator to find which node is lesser
  bool operator<(const Node& obj) {
      if(this->data < obj.data){
          return 1;
      }else{
 ...
 //overloads the != operator to check if two nodes are not equal
   bool operator!=(const Node& obj) {
       if(this->data != obj.data){
          return 1;
      }else{
  ...
  //overloads the == operator to check if two nodes are equal
   bool operator==(const Node& obj) {
       if(this->data == obj.data){
          return 1;
      }else{
